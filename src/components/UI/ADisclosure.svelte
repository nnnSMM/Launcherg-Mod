...
<Disclosure let:open {defaultOpen}>
  <DisclosureButton
    class="bg-transparent rounded transition-all w-full"
  >
    <div class="p-x-4 p-y-1 flex items-center gap-4 bg-transparent">
      <div class="text-text-primary text-xs">{label}</div>
      <div
