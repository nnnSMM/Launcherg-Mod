<script lang="ts">
  ...
  let companionComponentPromise: Promise<ComponentModule> | null = null;
  ...
  $: if (isCompanionRoute && !companionComponentPromise) {
    companionComponentPromise = import("@/views/MobileCompanion.svelte");
  }
  $: if (
    windowLabel === "main" &&
    !isLandingRoute &&
...
{:else if isLandingRoute && landingComponentPromise}
  {#await landingComponentPromise then module}
    <svelte:component this={module.default} />
  {/await}
{:else if isCompanionRoute && companionComponentPromise}
  {#await companionComponentPromise then module}
    <svelte:component this={module.default} />
  {/await}
{:else}
  <main
